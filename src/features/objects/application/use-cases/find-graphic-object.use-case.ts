...
import { FindGraphicObjectQuery, GraphicObjectResponseDto } from '../dto/index.js';
import { GRAPHIC_OBJECT_REPOSITORY, type GraphicObjectRepositoryPort } from '../ports/index.js';

@Injectable()
export class FindGraphicObjectUseCase implements UseCase<FindGraphicObjectQuery, GraphicObjectResponseDto> {
  constructor(@Inject(GRAPHIC_OBJECT_REPOSITORY) private readonly repo: GraphicObjectRepositoryPort) {}

  async execute(query: FindGraphicObjectQuery): Promise<GraphicObjectResponseDto> {

...
import { SECTION_OBJECT_REPOSITORY, SECTION_READER_FOR_SECTION_OBJECT, OBJECT_READER_FOR_SECTION_OBJECT, SECTION_OBJECT_EVENT_PUBLISHER, CreateSectionObjectUseCase, ListSectionObjectsUseCase, ListBySectionUseCase, ListByObjectUseCase, FindSectionObjectUseCase, UpdateSectionObjectUseCase, DeleteSectionObjectUseCase } from './application/index.js';
...
@Module({
  imports: [TypeOrmModule.forFeature([SectionObjectOrmEntity, SectionOrmEntity, GraphicObjectOrmEntity]), AuthModule],
  controllers: [SectionObjectsController],
  providers: [
    { provide: SECTION_OBJECT_REPOSITORY, useClass: SectionObjectTypeOrmRepository },
    { provide: SECTION_READER_FOR_SECTION_OBJECT, useClass: SectionTypeOrmReaderForSectionObject },
    { provide: OBJECT_READER_FOR_SECTION_OBJECT, useClass: ObjectTypeOrmReaderForSectionObject },
    { provide: SECTION_OBJECT_EVENT_PUBLISHER, useClass: SectionObjectEventNoopProvider },
